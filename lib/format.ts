...
export const THEMES = {
  ...
  dark: {
    ...
    vars: {
      ...
      "--color-accent": "#ee3b34",
      "--color-accent-100": "#2a1211",
      "--color-accent-200": "#3d1816",
      "--color-accent-300": "#8f0f0d",
      "--color-accent-400": "#cf1b17",
      "--color-accent-500": "#ee3b34",
      "--color-accent-600": "#f5a8a4",
      "--color-accent-700": "#fbd8d6",
      "--color-accent-800": "#fdf0ef",
      "--color-accent-900": "#fff8f7",
      ...
      "--color-hot": "#ee3b34",
      "--color-hot-700": "#fbd8d6",
      "--color-warn": "#f7b52a",
      "--color-ok": "#3ee87a",
      "--sig-red": "#ee3b34",
      "--sig-amber": "#f7b52a",
      "--color-signal": "#ee3b34",
      "--color-signal-200": "color-mix(in oklab, #ee3b34 22%, #161413)",
      "--color-signal-400": "color-mix(in oklab, #ee3b34 50%, #161413)",
