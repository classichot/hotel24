...
const LIGHT = {
  ...
  "--color-accent": "#ff6a3c",
  "--color-accent-100": "#fff3ee",
  "--color-accent-200": "#ffe0d4",
  "--color-accent-300": "#ffbda6",
  "--color-accent-400": "#ff8f6a",
  "--color-accent-500": "#ff6a3c",
  "--color-accent-600": "#e85224",
  "--color-accent-700": "#b33a16",
  "--color-accent-800": "#862c12",
  "--color-accent-900": "#581d0c",
  ...
  "--sig-amber": "#8a5a00",
  "--color-signal": "#ff6a3c",
  "--color-signal-200": "color-mix(in oklab, #ff6a3c 18%, #f3f2f2)",
  "--color-signal-400": "color-mix(in oklab, #ff6a3c 48%, #f3f2f2)",
  "--color-signal-700": "#b33a16",
...
export const THEMES = {
  ...
  dark: {
    ...
    vars: {
      ...
      "--color-accent": "#ff8f6a",
      "--color-accent-100": "#2a1410",
      "--color-accent-200": "#3d1c14",
      "--color-accent-300": "#862c12",
      "--color-accent-400": "#e85224",
      "--color-accent-500": "#ff6a3c",
      "--color-accent-600": "#ffbda6",
      "--color-accent-700": "#ffe0d4",
      "--color-accent-800": "#fff3ee",
      "--color-accent-900": "#fffaf8",
      ...
      "--sig-amber": "#f7b52a",
      "--color-signal": "#ff8f6a",
      "--color-signal-200": "color-mix(in oklab, #ff8f6a 22%, #161413)",
      "--color-signal-400": "color-mix(in oklab, #ff8f6a 50%, #161413)",
      "--color-signal-700": "#ffbda6",
      "--color-on-accent": "#201e1d",
      "--color-on-hot": "#201e1d",
      "--color-ink": "#f8f4f4",
      "--color-paper": "#201e1d",
