      ...
      <div className="split-main">
        ...
        <aside className="col-aside">
          ...
          <p className="text-muted" style={{ fontSize: 12, marginTop: 12 }}>
            <T en="Accent cells are AI-touched: weekend lift, Agoda last-minute, 2-night minimum, stop-sell. Apply queues ARI through the sync worker — the rate grid does not call OTAs itself." th="ช่องสีแดงคือจุดที่ AI แตะ: ขึ้นสุดสัปดาห์, นาทีสุดท้าย Agoda, ขั้นต่ำ 2 คืน, ปิดขาย กดใช้แล้วเข้าคิว ARI ผ่านตัวซิงก์ ตารางราคายิง OTA เองไม่ได้" />
          </p>
